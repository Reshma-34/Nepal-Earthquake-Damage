Course project team 12: Damage assessment in earthquake prone area
Team members: Aalok Patel, Reshma Patil, Yang Xiang, Manaswi Mishra

There are 3 folders inside 'modelling_data_codes', 'presentation', 'use_case_demo'

modelling_data_codes:

folder:
input_data -  data downloaded from Nepal govt website for this study.
clean_data - saved data after cleaning and preprocessing; also there are files for undersampling and oversampling of data
model_report - model report/performance matrix is saved in this folder
output - all prediction probabilities are saved and later used in ensemble model
plots - plots of model, clusters, important features are saved here
savedmodels - python models in pickle format and R models in R format are saved
...
All these codes were run in RCC - Midway 2:
...
Presentation:
Team presentation for this study. 

Use case demo:
Python code for use case 3 (Insurance for eathquake prone building)- built in flask
